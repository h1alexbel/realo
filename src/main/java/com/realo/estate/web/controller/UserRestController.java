...
import com.realo.estate.domain.user.ContactInfo;
import com.realo.estate.domain.user.Role;
import com.realo.estate.domain.user.UserAddress;
import com.realo.estate.dto.RegisterRequest;
...
public class UserRestController {
  ...
  public UserDto createUser(@RequestBody @Validated RegisterRequest registerRequest) {
    ...
    log.debug(USER_WAS_SAVED_IN_USER_CONTROLLER, savedUser);
    return savedUser;
  }
  ...
  public UserDto addNewAdmin(@RequestBody @Validated RegisterRequest registerRequest) {
    ...
    log.debug(ADMIN_WAS_SAVED_IN_USER_CONTROLLER, savedAdmin);
    return savedAdmin;
  }
  ...
  public ResponseEntity<?> deleteById(@PathVariable Long id) {
    ResponseEntity<Object> response = userService.deleteById(id)
        ? noContent().build()
        : notFound().build();
    log.debug(USER_WITH_ID_WAS_DELETED_IN_CONTROLLER, id);
    return response;
  }
  ...
  public UserDto update(@PathVariable Long id, @Validated @RequestBody UserDto userDto) {
    ...
    log.debug(USER_WAS_UPDATED_IN_CONTROLLER, updated);
    return updated;
  }
